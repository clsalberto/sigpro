    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                ...
                <input type="text" name="name" class="form-control" value="{{ $role->name }}" placeholder="{{ trans('template.fields.type') }}">
                @if ($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <ul class="todo-list">
                    @foreach($permissions as $permission)
                        <li>
                            <label>
                                <input type="checkbox" name="permissions[]" value="{{ $permission->id }}" {{ $role->permissions->contains($permission) ? 'checked' : ''}}>
